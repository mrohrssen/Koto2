...
describe('MatchManager', () => {
  ...
  describe('selectTeam and setReady', () => {
    ...
    it('_startBattle applies debug super attack only to allowlisted players with the setting on', () => {
      ...
      const pendingMatch = mm.getMatch(battleCode);
      pendingMatch.player1.username = 'michia';
      pendingMatch.player2.username = 'newplayer';
