#!/usr/bin/env python3
"""
Slice regen action icon grids into individual PNGs, replacing existing sliced icons.

Reads regen-batch-*.png grids + their manifests, slices into 128×128 icons,
and overwrites the corresponding files in sliced/.

Usage:
    python3 scripts/slice-regen-icons.py              # Process all regen grids
    python3 scripts/slice-regen-icons.py --batch 0    # Process specific batch
"""
...
def main():
    parser = argparse.ArgumentParser(description="Slice regen action icon grids")
