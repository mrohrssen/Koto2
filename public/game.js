...
import { renderButtons, renderButtonsAsync } from './js/ui/ui-components.js';
...
import {
  ...
  isExploreSyncResponseAuthCurrent as apiIsExploreSyncResponseAuthCurrent,
...
async function initGame() {
  ...
  explorationUI.init({
    ...
    isExploreSyncAuthCurrent: apiIsExploreSyncResponseAuthCurrent,
    apiRoomEncounter,
    apiGetCampfire,
    apiCookAtCampfire,
    apiFeedCampfireDish,
  ...
  setConnectionCallbacks({ onOffline: showOffline, onOnline: handleConnectionOnline });
