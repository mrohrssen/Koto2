/**
 * DEPRECATED: Full iRO-Based Stats System
 *
 * This file contains the complete iRO-style stat system with:
 * - 6 primary stats (STR, AGI, VIT, INT, DEX, LUK)
 * - 9 derived stats (ATK, DEF, MATK, MDEF, HIT, FLEE, CRIT, etc.)
 * - Stat point allocation with progressive costs
 * - Level-based scaling
 * - Complex combat mechanics (hit/miss, crits, armor pen, etc.)
 *
 * TO RESTORE THIS SYSTEM:
 * 1. Replace src/game/stats.js with this file
 * 2. Revert changes in: state.js, enemies.js, combat/mechanics.js, items/index.js
 * 3. Revert frontend changes in: public/game.js
 *
 * This file is preserved for potential future use when the game needs
 * more complex RPG mechanics.
 */

// iRO-Based Stats System (DEPRECATED - see stats.js for simplified system)
