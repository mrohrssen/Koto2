---
name: "source-command-game-design-studio"
...
# source-command-game-design-studio

Use this skill when the user asks to run the migrated source command `game-design-studio`.
